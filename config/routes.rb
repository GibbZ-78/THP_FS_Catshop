Rails.application.routes.draw do
  ...
  # JBV 16.03.2022 - Routes to 'update' method of the 'carts' controller created with the latter
  #                  Used to add a cat to the cart from the button of a given cat card
  patch '/carts/:cat_id', to: 'carts#update', as: 'add_cat_to_cart'
  put '/carts/:cat_id', to: 'carts#update'
